          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {cartItems.map((item) => {
                ...
                const customDesign = (item as any).design; // Design data from backend
                const hasCustomDesign = customDesign && customDesign.thumbnail;
                  ...
                  <Card key={item.id}>
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-4">
                        <img
                          src={hasCustomDesign 
                            ? customDesign.thumbnail 
                            : (product?.imageUrl || "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=120&h=120")
                          }
                          alt={hasCustomDesign 
                            ? `Custom Design: ${customDesign.name}` 
